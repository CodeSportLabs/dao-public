...
If you're a hackathon judge, investor, or grantee please email us <img src="https://codesport.io/assets/csi/images/posts/codesport-cares@2x.png" alt="email address" style="width:200px; margin-top:2px;"/> at to access this projects private repo and view our full code. Our latest contact info is [here](https://codesport.io/contact-us).
...
4. **Testnet Faucets:** Grab test USDC for Mumbai from [Swan Faucet](https://calibration-faucet.filswan.com/#/dashboard) and Testnet Matic from [Alchemy](https://mumbaifaucet.com/). These faucets are useful for interacting with our team wallet.
